            ...
            <v-simple-table>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td>
                            <p class="" v-if="organization.is_active == true">Активен</p>
                            <p class="" v-if="organization.is_active == false">Неактивен</p>
                        </td>
                        <td>
                            <v-btn @click.prevent="changeUserStatus(organization.id)" v-if="organization.is_active == false">
                                Активировать
                            </v-btn>
                            <v-btn @click.prevent="changeUserStatus(organization.id)" v-if="organization.is_active == true">
                                Деактивировать
                            </v-btn>
                        </td>
                    </tr>
